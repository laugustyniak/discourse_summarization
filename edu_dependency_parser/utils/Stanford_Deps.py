class2type = {
    ...
    'aux': ['aux', 'auxpass', 'cop'],
    'agent': ['agent'],
    'comp': ['comp', 'acomp', 'attr', 'ccomp', 'xcomp', 'complm', 'obj', 'dobj', 'iobj', 'pobj', 'mark', 'rel',
             'pcomp'],
    'subj': ['subj', 'nsubj', 'nsubjpass', 'csubj', 'csubjpass'],
    'cc': ['cc'],
    'conj': ['conj'],
    'expl': ['expl'],
    'mod': ['mod', 'abbrev', 'amod', 'appos', 'advcl', 'purpcl', 'det', 'predet', 'preconj', 'infmod', 'mwe', 'measure',
            'partmod', 'advmod', 'neg', 'rcmod', 'quantmod', 'nn', 'npadvmod', 'tmod', 'num', 'number', 'prep', 'prepc',
            'poss', 'possessive', 'prt'],
    'parataxis': ['parataxis'],
    'punct': ['punct'],
    'ref': ['ref'],
